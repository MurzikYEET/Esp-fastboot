...
flash <partition> <path/to/firmware.bin> : flash .bin file to target partition
wipe <partition> : write 0xFF in target partition
read <partition> <path/to/output.bin> : read partition and save to output path
